...
print('=' * 48)
print(f'{name[0]}\t\t{prices[0]}\t{quantities[0]}\t\t{prices[0]*quantities[0]}')
print(f'{name[1]}\t{prices[1]}\t{quantities[1]}\t\t{prices[1]*quantities[1]}')
print(f'{name[2]}\t\t{prices[2]}\t{quantities[2]}\t\t{prices[2]*quantities[2]}')
print(f'{name[3]}\t\t{prices[3]}\t{quantities[3]}\t\t{prices[3]*quantities[3]}')
print(f'{name[4]}\t\t{prices[4]}\t{quantities[4]}\t\t{prices[4]*quantities[4]}')
print('=' * 48)
total = (prices[0]*quantities[0] + prices[1]*quantities[1] + prices[2]*quantities[2] + prices[3]*quantities[3] + prices[4]*quantities[4])
print(f'총 매출 금액 = {total} 원')
print('=' * 48)